...
![Claude Code](https://img.shields.io/badge/Claude_Code-2.1.150-green.svg)
![OpenClaw](https://img.shields.io/badge/OpenClaw-v2026.5.22-blue.svg)
![Codex](https://img.shields.io/badge/Codex-v0.133.0-orange.svg)
...
- **🔄 持续更新**：适配最新版本（Claude Code v2.1.150 / OpenClaw 稳定版 v2026.5.22 / Codex CLI v0.133.0，实际以 GitHub Releases 和本机 `codex --version` 为准）
...
- **Codex CLI**：CLI v0.133.0 对照官方 Release；安装可用 OpenAI 官方 install script、Windows PowerShell install script、npm、Homebrew 或 GitHub Release 二进制包，实际以 [Codex CLI 文档](https://developers.openai.com/codex/cli) 为准
...
| **Claude Code版本** | 2.1.150（2026-05-25 验证） |
| **OpenClaw版本** | 稳定版 **v2026.5.22**（2026-05-25 对照 [Releases](https://github.com/openclaw/openclaw/releases)）；列表含预发布时请自行取舍 |
| **Codex版本** | CLI v0.133.0（2026-05-21 GitHub Release）；Codex App changelog 基线为 26.519；实际以 `codex --version`、App 更新日志与 [GitHub](https://github.com/openai/codex) 为准 |
...
| 产品 | 当前验证版本 | 验证日期 | 官方来源 |
|------|-------------|---------|---------|
| Claude Code | v2.1.150 | 2026-05-23 | [GitHub Releases](https://github.com/anthropics/claude-code/releases) |
| OpenClaw | 稳定版 v2026.5.22 | 2026-05-24 | [GitHub Releases](https://github.com/openclaw/openclaw/releases) |
| Codex CLI | v0.133.0 | 2026-05-21 | [GitHub Releases](https://github.com/openai/codex) |
...
- Claude Code 教程基于 **v2.1.150** 编写（[Release](https://github.com/anthropics/claude-code/releases/tag/v2.1.150)）；OpenClaw 教程以 **稳定版 v2026.5.22** 为修订参考；Codex 教程按 **Codex CLI v0.133.0 与 2026-05 OpenAI 官方 Codex 文档** 修订，CLI/App 版本以本机和官方 Releases 为准
