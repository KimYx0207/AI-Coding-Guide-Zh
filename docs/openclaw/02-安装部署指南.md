...
> **v2026.5.22 安装基线**：官方 README 当前写法是 Node 24 recommended，Node 22.19+ supported。新装优先走 `openclaw onboard`，升级和回滚按 release channel 选择 stable / beta / dev；教程里的固定版本号只用于复现问题，不建议长期锁死。
